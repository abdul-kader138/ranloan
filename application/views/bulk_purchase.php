				...
				<div class="panel-body">
					<form  id="Submitbulkinsert" action="<?=base_url()?>Purchase_order/SubmitBulkPurchase" method="post">
						...
						<div class="row">
							...
							?>
							<div class="col-md-2" id="total_weight">
								<div class="form-group">
									<label>Total Weight</label>
									<input type="text" name="total_weight"  class="form-control changecal" id="total_weight"   value="" />
								</div>
							</div>
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<input type="text" name="grand_total"   class="form-control " id="grand_total" placeholder=""  value="" />
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
...
<script>
	...
	// 			$.ajax({
	// 			type:'POST',
	// 			url:"<?=base_url()?>Purchase_order/getWeightProduct",
	// 			data: {product_id: product_id},
	// 			dataType: 'JSON',
	// 			success:function(data){
	// 				if (data.product_weight > 0) {
	// 					$('#total_weight').addClass('hide');
	// 				}else{
	// 					$('#total_weight').removeClass('hide');
	// 				}
