...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<!--<form action="<?=base_url()?>staff/insertStaff" method="post">-->
					...
					<div class="row">
                        ...
                        <div class="col-md-3">
							...
							<div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" maxlength="254" required autocomplete="off" value="" />
							</div>
						</div>
                                          </div>
                                    <div class="row">   
                        ...
                        <div class="col-md-3">
							<div class="form-group">
								<label>Upload Photo<span style="color: #F00">*</span></label>
								<input type="file" name="thumbnail" class="form-control" maxlength="499"   autocomplete="off"  />
                                                                <label>Image Size, Maximum 150 kb</label>
							</div>
						</div>
                                                   <div class="col-md-3">
                            <div class="form-group">
...
<!--   
                                <label>Entitled for the Points </label> <br>
                                 <input type="radio" name="title_points" class="radioBtn" value="1" /> Yes
                                <input type="radio" name="title_points" class="radioBtn" value="0" checked /> No-->
                            </div>
                        </div>
...
<!--                                 <input type="radio" name="isview"  value="1" /> Yes
                                 <input type="radio" name="isview"  value="2" checked /> No-->
                            </div>
                        </div>
