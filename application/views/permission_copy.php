						...
						<div class="box-body ">
							<table  class="table table-hover table-stripped table-bordered" id="data-table1" >
								...
								<tbody id="">
									...
									<?php
									function rec($array,$sel_view_menu_right_arr,$sel_add_right_arr, $sel_edit_right_arr, $sel_view_right_arr, $sel_delete_right_arr, $sel_print_right_arr, $sel_email_right_arr, $sp = '&nbsp;&nbsp;&nbsp;') {
										$count = 0;
										...
										<tr <?php echo isset($val['children']) ? 'style="background-color:#f8f8f8;"' : ''; ?> >
											...
											<td>
												<input type="checkbox" class="minimal" value="1" <?php echo $sel_view_menu_right == 1 ? 'checked="checked"' : ''; ?> name="view_menu_right[<?php echo $key; ?>]"/>
											</td>
										...
										{
											$sp .= '&nbsp;&nbsp;&nbsp;';
											rec($val['children'],$sel_view_menu_right_arr, $sel_add_right_arr, $sel_edit_right_arr, $sel_view_right_arr, $sel_delete_right_arr, $sel_print_right_arr, $sel_email_right_arr, $sp);
										}
									}
								}
								...
								foreach ($resource_dd_temp as $key => $val) 
								{
									...
									<?php
									isset($val['children']) ? rec($val['children'],$sel_view_menu_right_arr, $sel_add_right_arr, $sel_edit_right_arr, $sel_view_right_arr, $sel_delete_right_arr, $sel_print_right_arr, $sel_email_right_arr) : '';
								}
								?>
								</tbody>
							</table>
