							...
							<div class="table-responsive">
								<table id="datatable" class="table">
									...
									<tbody>
										...
										{
											$totalQtysold = $totalQtysold + $value->weight;
											...
											<tr>
												...
												<td><?=!empty($value->gold_total_qty_item)?number_format($value->weight,2):0?></td>
					...
					<h3 style="color: #990000;">Summery</h3>
						...
						<div class="col-md-12">
							<table>
								<tbody>
									<tr>
										<td><label style="color:#333333; font-size: 16px;">Total weight Sold:</label> </td>
