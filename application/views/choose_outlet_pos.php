...
<div class="col-sm-12 col-lg-12 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header" style="text-align: center; padding-bottom: 0px; margin-bottom: 10px;">Choose Outlet</h1>
		</div>
	</div><!--/.row-->
								...
								<a href="<?=base_url()?>pos/updateOwnerOutlet?outlet_id=<?php echo $outlet_id; ?>" style="text-decoration: none">
									<div class="row" <?php if ($i > 0) {
										...
										<div class="col-md-10" style="background-color: #373942; border-radius: 5px; text-align: center; padding-top: 10px; padding-bottom: 10px;">
											...
											<p style="color: #FFF;">Address : <?php echo $outlet_address; ?></p>
											<p style="color: #FFF;">Tel : <?php echo $outlet_contact; ?></p>
										</div>
										<div class="col-md-1">&nbsp;</div>
									</div>
								</a>
