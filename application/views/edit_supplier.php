...
<!--							<form action="<?=base_url()?>setting/deleteSupplier" method="post" onsubmit="return confirm('Do you want to delete this Suppler : <?php echo $supplier_name; ?>?')">
							...
							<button type="submit" class="btn btn-primary edit_popup_click" style="border: 0px; background-color: #c72a25;">
									Delete Supplier
							</button>
						</div>
					</div>
					
					<div class="message-box animated fadeIn edit_supplier" data-sound="alert" id="mb-signout">
						<div class="mb-container">
							<div class="mb-middle">
								<div class="mb-title"><span class="fa fa-times "></span> Remove<strong></strong> ?</div>
								<div class="mb-content">
									<p>Do you want to delete this Suppler :<?php echo $supplier_name; ?>?</p>                    
									<p>Press No if youwant to continue work. Press Yes to Remove current Suppler.</p>
									
								</div>
								<div class="mb-footer">
									<div class="pull-right">
										<form action="<?=base_url()?>setting/deleteSupplier" method="post" >
											<input type="hidden" name="supplier_id" value="<?php echo $id; ?>" />
											<input type="hidden" name="supplier_name" value="<?php echo $supplier_name; ?>" />
											<button type="submit" class="btn btn-success btn-lg remove_row" >Yes</button>
...
<script>
 $(document).ready(function () {
	//popupbox
		$(".edit_popup_click").click(function () {
