                        ...
                        <table class="table" id="datatable">
                           <thead>
                              <tr>
                                 ...
                                 <th style="text-align: left;border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" width="17%">Customer Name</th>
                                 <th style="text-align: left;border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" width="17%">NIC</th>
                                 <th style="text-align: left;border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" width="17%">Total Loan Balance</th>
                                 <th style="text-align: left;border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" width="17%">Points</th>
                                 <th style="text-align: left;border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" width="17%">Overdue Status</th>
                                 <th style="text-align: left;border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd; border-right: 1px solid #ddd;" width="14%">Action</th>
                              </tr>
                           </thead>
                           <tbody>
                              <?php
                              // print_r($results); 
                                 if (count($results) > 0) {
                                    foreach ($results as $data) {
                                       ...
                                       $outstanding = !empty($outstanding)?$outstanding:0;

                                    ?>
                              <tr>
                                 <td style="display: none;"><?php echo $cust_id; ?></td>

                                 <td style="border-bottom: 1px solid #ddd;"><?php echo $data->fullname; ?></td>
                                 ...
                                 <td style="border-bottom: 1px solid #ddd;">
                                    <?php echo !empty($customer_Point)?$customer_Point:0; ?> 
                                 </td>
                                 <td style="border-bottom: 1px solid #ddd;">
                                    <?php
                                    ?>
                              ...
                              <div class="modal-body" style="overflow: visible; background-color: #FFF;">
                                 <form id="paymentSubmit" method="post">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-4">
                                          <input type="text"  class="form-control ChangeAmount" placeholder="0.00" />
      ...
      $(".table-responsive").on("click", ".popdebit", function() {
         ...
         $.ajax({
            ...
            success:function(data){
               ...
               var toamt1= total.toFixed(3)
               $('#totalamount1').val(toamt1);
               $('.BalanceAmount').val(toamt1);
