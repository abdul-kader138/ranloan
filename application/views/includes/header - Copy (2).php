...
<!--								<li><a onclick = "if (!confirm('Are your sure logout ?')) {
	...
	?>
								...
								<ul class="children <?php if ($tk_c != 'sales' && ($tk_c != 'customers' && $tk_c != 'gold' && $tk_c != 'settlement' && $tk_c != 'debit' && $tk_c != 'pos' && $tk_c != 'returnorder' )) { ?> collapse <?php } ?> 
									...
									if (array_key_exists(strtolower('view'), $rule_array) && array_key_exists(ci_is_sub_module('debit', 'view'), $rule_array)) {
										...
										if (($rule_array['list_sales']->view_menu_right == 1)) {
											?> 
											<li> <a <?php if (($tk_c == 'list_sales')) { ?> class='sub-active'  <?php } ?> href="<?= base_url() ?>sales/list_sales"> Today Sales </a> </li>
										...
										if (array_key_exists(strtolower('settlement'), $rule_array)) {
											...
											<li <?php if ($tk_c == 'returnorder') { ?> class="parent active" <?php
												...
												?>>
												<a <?php if ($tk_c == 'returnorder') { ?> class="parent active" style="background: #005b8a!important; color: #ffffff!important;" <?php
												} else {
													echo 'class="parent"';
												}
												?> data-toggle="collapse" href="#salereturn">
												Sales Return
											</a>
										<?php
										// start new
					...
					<!------------------- Start Gold Module ------------->    
							...
							if (array_key_exists(strtolower('gold'), $rule_array)) {
								if (($rule_array['view_transfer']->view_menu_right == 1)) {
									?>  
											<li> <a <?php if ($this->router->method == 'view_transfer') { ?> class="sub-active" <?php } ?> href="<?= base_url() ?>Gold/view_transfer">Transfer</a> </li>
																													   <?php }
																												   }
																												   ?> 
									...
									if (array_key_exists(strtolower('gold'), $rule_array)) {
										if (($rule_array['list_store_transfer']->view_menu_right == 1)) {
											?> 
											<li> <a <?php if ($this->router->method == 'list_store_transfer') { ?> class="sub-active" <?php } ?> href="<?= base_url() ?>Gold/list_store_transfer">View Store Record</a> </li>
										<?php }
									}
									?> 
									...
									<?php if (array_key_exists(strtolower('gold'), $rule_array)) {
										...
										if (array_key_exists(strtolower('gold'), $rule_array)) {
											if (($rule_array['Gold_gradeview']->view_menu_right == 1)) {
												?> 
												<li> <a <?php if ($this->router->method == 'Gold_gradeview') { ?> class="sub-active" <?php } ?> href="<?= base_url() ?>Gold/Gold_gradeview">Gold Grade List</a> </li>
											<?php
											}
										}
									}
			...
			if (array_key_exists(strtolower('productions'), $rule_array)) {
				if (($rule_array['list_goldsmith_wastage']->view_menu_right == 1)) {
					?> 
											<li> <a <?php if (($tk_c == 'Productions' && $this->router->method == 'list_goldsmith_wastage')) { ?> class="sub-active" <?php } ?> href="<?= base_url() ?>Productions/list_goldsmith_wastage">Goldsmith Wastage </a> </li>
				<?php }
			}
			?>
							...
							if (array_key_exists(strtolower('productions'), $rule_array)) {
								...
								if (($rule_array['all_work_job_order']->view_menu_right == 1)) {
									?> 
											<li> <a <?php if (($tk_c == 'Productions' && $this->router->method == 'all_work_job_order')) { ?> class="sub-active" <?php } ?> href="<?= base_url() ?>Productions/all_work_job_order">Work /Job Order </a> </li>
										<?php }
									}
									?>
									...
									?> 
										<li> <a <?php if (($tk_c == 'Productions' && $this->router->method == 'receive_work_job_order')) { ?> class="sub-active" <?php } ?> href="<?= base_url() ?>Productions/receive_work_job_order">Receive Work /Job Order </a> </li>
										<?php }
									?>		
									...
									if (array_key_exists(strtolower('productions'), $rule_array)) {
										if (($rule_array['producation_receive']->view_menu_right == 1)) {
											?> 
											<li> <a <?php if (($tk_c == 'Productions' && $this->router->method == 'producation_receive')) { ?> class="sub-active" <?php } ?> href="<?= base_url() ?>Productions/producation_receive">Producation Receive </a> </li>
										<?php }
									}
									?>
								...
								<ul class="children <?php if ($tk_m != 'bakerySales' && $tk_m != 'issue_sale_report') { ?> collapse <?php } ?>
									...
									if (array_key_exists('bakerySales', $rule_array)) {
										if (($rule_array['bakerySales']->view_menu_right == 1)) {
											?> 
											<li> <a <?php if (( $this->router->method == 'bakerySales')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>bakery_sales/bakerySales">Bakery Sales</a> </li>
										...
										if (($rule_array['issue_sale_report']->view_menu_right == 1)) {
											?> 
											<li> <a <?php if (( $this->router->method == 'issue_sale_report')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>reports/issue_sale_report">Issue Sales Report</a> </li>
										<?php }
									}
									?>
							...
							<li <?php echo ($tk_c == 'pumps') ? 'class="parent active"' : 'class="parent"'; ?>>
								...
								<?php if ($tk_m == 'index' || $tk_m == 'list_operators' || $tk_m == 'list_ft' || $tk_m == 'pumpSales' || $tk_m == 'pumperreport' || $tk_m == 'fuelType' || $tk_m == 'settelment') { ?> children in <?php } ?>" id="pumps">
									...
									if (array_key_exists(strtolower('index'), $rule_array) && array_key_exists(ci_is_sub_module('pumps', 'index'), $rule_array)) {
										if (($rule_array['pumps']->view_menu_right == 1)) {
											?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'index')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps">List Pumps</a></li>
										...
										if (($rule_array['list_operators']->view_menu_right == 1)) {
											?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'list_operators')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/list_operators">List Pump Operators</a></li>
										...
										if (($rule_array['list_ft']->view_menu_right == 1)) {
											?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'list_ft')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/list_ft">List Fuel Tanks</a></li>
											<?php
										}
									} if (array_key_exists(strtolower('pumpSales'), $rule_array)) {
										if (($rule_array['pumpSales']->view_menu_right == 1)) {
											?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'pumpSales')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/pumpSales">Pump Comm & Shortage</a></li>
										<?php }
									}
									?> 
									...
									if (array_key_exists(strtolower('settlement_pump'), $rule_array)) {
										if (($rule_array['settlement_pump']->view_menu_right == 1)) {
											?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'settlement')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/settlement">Settlement</a></li>
										<?php }
									}
									?>
									...
									if (array_key_exists(strtolower('settlement_list'), $rule_array)) {
										if (($rule_array['settlement_list']->view_menu_right == 1)) {
											?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'settlement_list')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/settlement_list">Settlement List</a></li>
										<?php }
									}
									?>
									...
									if (array_key_exists(strtolower('deleted_settlement'), $rule_array)) {
										if (($rule_array['deleted_settlement']->view_menu_right == 1)) {
											?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'deleted_settlement')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/deleted_settlement">Deleted Settlement</a></li>
										<?php }
									}
									?>
									...
									if (array_key_exists(strtolower('escTax'), $rule_array)) {
										if (($rule_array['escTax']->view_menu_right == 1)) {
											?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'escTax')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/escTax">Esc Tax</a></li>
								...
								if (($rule_array['pumperreport']->view_menu_right == 1)) {
									?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'pumperreport')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/pumperreport">Pump Operator Reports</a></li>
								...
								if (($rule_array['fuelsalereport']->view_menu_right == 1)) {
									?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'fuelsalereport')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/fuelsalereport">Fuel Sale Reports</a></li>
				<?php }
			}
			?>
									...
									if (array_key_exists(strtolower('dipreport'), $rule_array)) {
										if (($rule_array['dipreport']->view_menu_right == 1)) {
											?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'dipreport')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/dipreport">Dip Reports</a></li>
										<?php }
									}
									?>
									...
									if (array_key_exists(strtolower('daily_collection'), $rule_array)) {
										if (($rule_array['daily_collection']->view_menu_right == 1)) {
											?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'daily_collection')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/daily_collection">Daily Collection</a></li>
										<?php }
									}
									?>
							...
							if (array_key_exists(strtolower('pump_reading'), $rule_array)) {
								if (($rule_array['pump_reading']->view_menu_right == 1)) {
									?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'pump_reading')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/pump_reading">Pump Reading</a></li>
				<?php }
			}
			?>
							...
							if (array_key_exists(strtolower('fuel_reading'), $rule_array)) {
								if (($rule_array['fuel_reading']->view_menu_right == 1)) {
									?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'fuel_reading')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/fuel_reading">Fuel Tank Reading</a></li>
				<?php }
			}
			?>
									...
									if (array_key_exists(strtolower('testing_detail'), $rule_array)) {
										if (($rule_array['testing_detail']->view_menu_right == 1)) {
											?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'testing_detail')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/testing_detail">Testing Detail</a></li>
										<?php }
									}
									?>
									...
									if (array_key_exists(strtolower('meter_resetting'), $rule_array)) {
										if (($rule_array['meter_resetting']->view_menu_right == 1)) {
											?> 
											<li><a <?php if (($tk_c == 'pumps' && $this->router->method == 'meter_resetting')) { ?> class='sub-active' <?php } ?>  href="<?= base_url() ?>pumps/meter_resetting">Meter Resetting</a></li>
				<?php }
			}
			?>
								...
								<ul class="children <?php if ($tk_c != 'inventory' && $tk_c != 'products' && $tk_c != 'sub_category' && $tk_c != 'brand') { ?> collapse <?php } ?>
									...
									<?php if (($rule_array['products']->view_menu_right == 1)) { ?>
										...
										<li  <?php if ($tk_c == 'products') { ?> class="parent active" <?php
												...
												?>>
											<a <?php if ($tk_c == 'products') { ?> class="parent active" style="color: #ffffff !important; background: #005b8a!important;" <?php
										} else {
											echo 'class="parent"';
										}
										?> data-toggle="collapse" href="#products">
												Products
											</a>
				...
				if (($rule_array['bank_accounts']->view_menu_right == 1)) {
					?> 
						...
						<li><a <?php if (($tk_c == 'bank_accounts' && ($this->router->method == 'view' || $this->router->method == 'index'))) { ?> class="sub-active" <?php } ?>  href="<?= base_url() ?>bank_accounts">Bank Accounts</a></li>
								...
								<?php if (array_key_exists(strtolower('bank_transaction'), $rule_array)) {
									...
									<?php if (array_key_exists(strtolower('receivedcheque'), $rule_array)) {
	...
	if (array_key_exists(strtolower('gift_card'), $rule_array)) {
		if (($rule_array['gift_card']->view_menu_right == 1)) {
			...
			<?php if ($tk_m == 'gift_card' || $this->router->method == 'list_gift_card') { ?> children in <?php } ?>" id="sub-item-gift">
									<?php
				...
				if (array_key_exists(strtolower('add_gift_card'), $rule_array)) {
					if (($rule_array['add_gift_card']->view_menu_right == 1)) {
						?> 
												<li> <a <?php if (($tk_c == 'gift_card' && $this->router->method == 'add_gift_card')) { ?> class="sub-active" <?php } ?> href="<?= base_url() ?>gift_card/add_gift_card"> Add Gift Card
													</a>
												</li>
											<?php }
										}
			...
			<?php if ($tk_m == 'sales_report' || $tk_m == 'product_category_report') { ?> children in <?php } ?>"
							...
							if (array_key_exists(strtolower('sales_report'), $rule_array)) {
								if (($rule_array['sales_report']->view_menu_right == 1)) {
									?>
											<li><a <?php if (($this->router->method == 'sales_report')) { ?> class="sub-active" <?php } ?>
								...
								if (($rule_array['product_report']->view_menu_right == 1)) {
									?>
											<li>
												<a <?php if (($this->router->method == 'product_report')) { ?> class="sub-active" <?php } ?>
									...
									if (array_key_exists(strtolower('product_category_report'), $rule_array)) {
										if (($rule_array['product_category_report']->view_menu_right == 1)) {
											?>
											<li>
												<a <?php if (($this->router->method == 'product_category_report')) { ?> class="sub-active" <?php } ?>
									...
									if (array_key_exists(strtolower('sales_report_payement'), $rule_array)) {
										if (($rule_array['sales_report_payement']->view_menu_right == 1)) {
											?>
											<li>
												<a <?php if (($this->router->method == 'sales_report_payement')) { ?> class="sub-active" <?php } ?>
			...
			?>
							...
							if (array_key_exists(strtolower('daily_summary_report'), $rule_array)) {
								if (($rule_array['daily_summary_report']->view_menu_right == 1)) {
									?>
											<li>
												<a <?php if (($this->router->method == 'daily_summary_report')) { ?> class="sub-active" <?php } ?>
								...
								if (($rule_array['credit_sales_payment']->view_menu_right == 1)) {
									...
									if (array_key_exists(strtolower('taxes'), $rule_array)) {
										if (($rule_array['taxes']->view_menu_right == 1)) {
											?>
											<li>
												<a <?php if (($this->router->method == 'taxes')) { ?> class="sub-active" <?php } ?>
									...
									if (array_key_exists(strtolower('product_batch_expiry'), $rule_array)) {
										if (($rule_array['product_batch_expiry']->view_menu_right == 1)) {
											?>
											<li>
												<a <?php if (($this->router->method == 'product_batch_expiry')) { ?> class="sub-active" <?php } ?>
	...
	?>
					...
					<!------------------- Start Profit Loss Module ------------->    
							...
							<li <?php if ($tk_c == 'pnl' || $tk_c == 'pnl_report') { ?> class="parent active" <?php
											} else {
												echo 'class="parent"';
											}
											?>>
					...
					<!------------------- Start Setting Module ------------->    
								...
								<li <?php if ($tk_c == 'setting' || $tk_c == 'Bill_Numbering' || $tk_c == 'staff' || $tk_c == 'Product_Code_Numbering') { ?> class="parent active" <?php
									...
									<ul class="children <?php if ($tk_c != 'setting') { ?> collapse <?php } ?>
										...
										if (array_key_exists(strtolower('outlets'), $rule_array)) {
											if (($rule_array['outlets']->view_menu_right == 1)) {
												?> 
												<li>
													<a <?php if (($this->router->method == 'outlets') || ($this->router->method == 'addoutlet') || ($this->router->method == 'editoutlet')) {
									?> class="sub-active" <?php } ?> href="<?= base_url() ?>setting/outlets">
											...
											if (($rule_array['users']->view_menu_right == 1)) {
												?> 
												<li>
													<a <?php if (($this->router->method == 'users') || ($this->router->method == 'adduser') || ($this->router->method == 'edituser')) {
						...
						?> href="<?= base_url() ?>setting/users">
											...
											if (($rule_array['staff']->view_menu_right == 1)) {
												?> 
												<li>
													<a <?php if (($this->router->method == 'view') || ($this->router->method == 'addStaff') || ($this->router->method == 'edit_staff')) {
													?> class="sub-active" <?php }
					...
					if (($rule_array['permission']->view_menu_right == 1)) {
						?> 
												...
												<li>
													<a <?php if (($this->router->method == 'permission') || ($this->router->method == 'addPermission') || ($this->router->method == 'edit_permission')) {
							?> class="sub-active" <?php }
						?> href="<?= base_url() ?>setting/permission">
														Permission
													</a>
					...
					if (($rule_array['payment_methods']->view_menu_right == 1)) {
						?> 
										<?php if (ci_permissionSysAdminRole()) { ?>
													<li>
														<a <?php if (($this->router->method == 'payment_methods') || ($this->router->method == 'addpaymentmethod') || ($this->router->method == 'editpaymentmethod')) {
												?> class="sub-active" <?php }
				...
				if (array_key_exists(strtolower('bill_numbering'), $rule_array)) {
					if (($rule_array['bill_numbering']->view_menu_right == 1)) {
						?> 
										<?php if (ci_permissionSysAdminRole()) { ?>
													<li>
														<a <?php if (($this->router->method == 'bill_numbering') || ($this->router->method == 'add_bill_numbering')) {
								?> class="sub-active" <?php }
				...
				if (array_key_exists(strtolower('product_code_numbering'), $rule_array)) {
					if (($rule_array['product_code_numbering']->view_menu_right == 1)) {
						...
						<?php if (ci_permissionSysAdminRole()) { 
							?>
								<li>
									<a <?php if (($this->router->method == 'product_code_numbering' || $this->router->method == 'index')) {
								?> class="sub-active" <?php }
				...
				if (array_key_exists(strtolower('add_new_page'), $rule_array)) {
					if (($rule_array['add_new_page']->view_menu_right == 1)) {
						...
						<?php if (ci_permissionSysAdminRole()) { ?>
													<li>
														<a <?php if (($this->router->method == 'add_new_page')) {
								?> class="sub-active" <?php }
				...
				if (array_key_exists(strtolower('download_database'), $rule_array)) {
					if (($rule_array['download_database']->view_menu_right == 1)) {
						...
						<?php if (ci_permissionSysAdminRole()) { ?>
													<li>
														<a <?php if (($this->router->method == 'download_database')) {
								?> class="sub-active" <?php }
