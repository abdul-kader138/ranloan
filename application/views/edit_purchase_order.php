	...
	<div class="row">
		<div class="col-lg-12">
			<?php
                if ($po_status == '1') {
                    ?>
			<h1 class="page-header">Edit Purchase Order before Send To Supplier</h1>
			<?php

                } else {
                    ?>
			<h1 class="page-header">Sent To Supplier</h1>
			<?php
			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<label style="color: #c72a25;">Purchase Order Status <span style="color: #F00">*</span></label>
								...
								<?php
                                    ...
                                    for ($ps = 0; $ps < count($poStatusData); ++$ps) {
                                        ...
                                        if ($po_status == '1') {
                                            if ($poStatus_id == '2') {
                                                $poStatus_name = 'Send To Supplier';
                                            }
                                        } ?>
					...
					<div class="row" style="padding-top: 7px;">
						...
						<div class="col-md-8">
							<label>&nbsp;</label>
							<div style="background-color: #686868; color: #FFF; width: 100px; text-align: center; border-radius: 4px; padding: 9px 0px; cursor: pointer;" id="addToList">Add To List</div>
						</div>
					</div>
					<?php
...
<div class="table-responsive">
	<table class="table">
		<thead>
			<tr>
		    	<th width="30%" style="background-color: #686868; color: #FFF;">Product Code</th>
		    	<th width="30%" style="background-color: #686868; color: #FFF;">Product Name</th>
		    	<th width="30%" style="background-color: #686868; color: #FFF;">Ordered Qty.</th>
