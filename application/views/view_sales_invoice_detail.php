								...
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											...
											foreach ($getItemOrder as $item) {
												...
												$totalprice = !empty($item->price)?$item->price:0;
												$subtotal = !empty($item->qty)?$item->qty:0 * !empty($item->price)?$item->price:0;
												$totalsubtotal = $subtotal;
												$totalgrandtotal = !empty($item->grandtotal)?$item->grandtotal:0;
												?>
												<tr>
													...
													<td style="text-align: left;"><?=!empty($item->price)?$item->price:'' ?></td>
													<td style="text-align: left;"><?=!empty($item->qty)?$item->qty:'' ?></td>
													<td style="text-align: left;"><?=!empty($subtotal)?$subtotal:0.00 ?></td>
													<td style="text-align: left;"><?=!empty($item->tax)?$item->tax:0.00?></td>
													<td style="text-align: left;"><?=!empty($item->discount)?$item->discount:0?></td>
													<td style="text-align: left;"><?=!empty($item->grandtotal)?$item->grandtotal:0.00 ?></td>
												</tr>
										<?php
									...
									<?php	}
											...
											<tr>
												...
												<td style="text-align: left;"><b><?=!empty($totalprice)?$totalprice:0.00 ?></b></td>
												<td style="text-align: left;"><b><?=!empty($totalqty)?$totalqty:0.00 ?></b></td>
												<td style="text-align: left;"><b><?=!empty($totalsubtotal)?$totalsubtotal:0.00?></b></td>
												<td style="text-align: left;"></td>
												<td style="text-align: left;"></td>
												<td style="text-align: left;"><b><?=!empty($totalgrandtotal)?$totalgrandtotal:0.00 ?></b></td>
											</tr>
										</tbody>
									</table>
								...
								<div class="table-responsive">
									<table class="table">
										...
										foreach ($getPaymentOrder as $payment) {
											$paid_amt = !empty($payment->paid_amt)?$payment->paid_amt:0;
											$unpaid_amt = !empty($payment->unpaid_amt)?$payment->unpaid_amt:0;
											$subtotal = !empty($payment->subtotal)?$payment->subtotal:0;
											$grandtotal = !empty($payment->grandtotal)?$payment->grandtotal:0;
											?>
												<tr>
													...
													?></td>
													<td style="text-align: left;"><?=!empty($payment->paid_amt)?$payment->paid_amt:0.00 ?></td>
													<td style="text-align: left;"><?=!empty($payment->unpaid_amt)?$payment->unpaid_amt:0.00 ?></td>
													<td style="text-align: left;"><?=!empty($payment->subtotal)?$payment->subtotal:0.00 ?></td>
													<td style="text-align: left;"><?=!empty($payment->grandtotal)?$payment->grandtotal:0.00?></td>
												</tr>
											<?php }
											?>
											<tr>
												<td colspan="2" style="text-align: left;"><b>Total</b></td>
												<td style="text-align: left;"><b><?=!empty($paid_amt)?$paid_amt:0.00 ?></b></td>
												<td style="text-align: left;"><b><?=!empty($unpaid_amt)?$unpaid_amt:0.00 ?></b></td>
												<td style="text-align: left;"><b><?=!empty($subtotal)?$subtotal:0.00 ?></b></td>
												<td style="text-align: left;"><b><?=!empty($grandtotal)?$grandtotal:0.00?></b></td>											</tr>
										</tbody>
									</table>
								</div>
							</div>
