				...
				<div class="panel-body">
					...
					<div class="row" style="border-bottom: 1px solid #e0dede; padding-bottom: 8px; margin-top: -5px;">
						...
						<div class="col-md-6" style="text-align: right;">
							<a href="<?=base_url()?>Gold/exportSearchCustomer?search_name=<?php echo $search_name; ?>&search_email=<?php echo $search_email; ?>&search_mobile=<?php echo $search_mobile; ?>" style="text-decoration: none;">
								...
								<table class="table">
									<thead>
										<tr>
									    	...
									    	<th style="border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" width="26%">Email</th>
										    <th style="border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" width="20%">Mobile</th>
										    <th style="border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd; border-right: 1px solid #ddd;" width="25%">Action</th>
										</tr>
									</thead>
									<tbody>
<?php
