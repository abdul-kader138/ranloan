...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Reserved Item List</h1>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
								...
								<table id="example" class="table" cellspacing="0" width="100%">
									<thead>
										<tr>
                                            ...
                                            <th width="10%">Sales invoice No</th>
									...
									<tbody>
									  ...
									  ?>
										...
										foreach($getSalesResult as $view){ 
											if(!empty($view->sale_invoice_num))
											$sale_invoice_num = $view->sale_invoice_num;
											else
											$sale_invoice_num = '';
										?>
										<tr>
											<td><?=$view->sales_ordered_datetime?></td>
											<td><?=$view->sales_outlet_name?></td>
                                            <td><?=$view->sales_id?></td>
											<td><?=$view->sale_invoice_num?></td>
											<td><?=$view->sub_category_name?></td>
											<td><?=$view->product_code?></td>
											<td><?=$view->product_name?></td>
											<td><!--< ?=$view->sales_delivery_date?> --> </td>
											<td><button class="btn btn-primary oldModelHide" style="width: 70px;padding: 4px 12px;"   data-toggle="modal" data-target="#myModal<?php echo $view->order_item_id; ?>">View</button>
											</td>
										</tr>
													...
													<div class="modal-content">
														...
														<div class="modal-body">
															<div class="row">
																...
																<div class="col-md-8">
																	<?= date('d-m-Y H:i:s', strtotime($view->sales_ordered_datetime)) ?>
																</div>
															</div>
