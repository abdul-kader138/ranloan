...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Search Expenses</h1>
		</div>
	</div><!--/.row-->
						...
						<div class="row">
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									?>
											<option value="<?php echo $se_id; ?>" <?php if($se_id == $search_category){ echo 'selected="selected"'; } ?>>
												<?php echo $se_name; ?>
											</option>
									<?php
											unset($se_id);
...
<?php
    if ($user_outlet < 3) {
        ?>								
		<a href="<?=base_url()?>expenses/deleteExpenses?id=<?php echo $id; ?>" style="text-decoration: none; margin-left: 10px;" title="Delete" onclick="return confirm('Are you confirm to delete this Expenses?')">
