...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Add New Expense Category</h1>
		</div>
	</div><!--/.row-->
	
	<form id="expence_valida" action="<?=base_url()?>expenses/insertExpenseCategory" method="post">
	<div class="row">
		<div class="col-md-12">
