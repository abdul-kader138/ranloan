										...
										<?php
											...
											{ 
												...
												<tr>
													...
													<td width="10%"><?php echo $value->created_date; ?>
													</td>	
													<td width="10%"><?php echo $value->outletname; ?></td>	
														<td width="10%">
															<?php
															$string = '';
															$inventorydate = $this->Reports_model->getInventoryDetail($value->product_code);
													...
													<td width="10%"><?=!empty($value->opening_qty)?number_format($value->opening_qty,2):0?></td>	
													<td width="10%"><?=!empty($value->purchase_qty)?number_format($value->purchase_qty,2):0?></td>	
													<td width="10%"><?=!empty($value->bonusqty)?number_format($value->bonusqty,2):0?></td>	
													<td width="10%"><?=!empty($value->sales_qty)?number_format($value->sales_qty,2):0?></td>	
													<td width="10%"><?=!empty($value->balance_qty)?number_format($value->balance_qty,2):0?></td>	
												</tr>
											<?php 
											}
											?>
...
<!--									<tr>
									...
									<?php 
											...
											{ 
												...
												// 	$Starqty = 0;
												// }else{
													$Starqty =$this->db->select('opening_qty')->from('product_report')->where('product_code',$value->code)->ORDER_BY('id','DESC')->limit(0)->get()->row()->opening_qty;
												// }
												
												$prchqty =(!empty($TodayAllQty->TotalPurchaseQty)?$TodayAllQty->TotalPurchaseQty:0); 
