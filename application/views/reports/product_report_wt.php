										...
										<?php
											...
											{ 
												...
												<tr>
													...
													<td width="10%"><?=!empty($value->opening_wt)?number_format($value->opening_wt,2):0?></td>	
													<td width="10%"><?=!empty($value->purchase_wt)?number_format($value->purchase_wt,2):0?></td>	
													<td width="10%"><?=!empty($value->bonus_wt)?number_format($value->bonus_wt,2):0?></td>	
													<td width="10%"><?=!empty($value->sales_wt)?number_format($value->sales_wt,2):0?></td>	
													<td width="10%"><?=!empty($value->balance_wt)?number_format($value->balance_wt,2):0?></td>	
												</tr>
											<?php 
											}
											?>
