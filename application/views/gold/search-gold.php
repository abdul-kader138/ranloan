...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><?php echo "Refined Gold List ";?></h1>
        </div>
    </div><!--/.row-->
                    ...
                    <?php
                        ...
                        <div class="col-md-10">
                           ...
                           <a href="<?=base_url()?>Refine_gold/add_refine_order" style="text-decoration: none;">
                                ...
                                <!-- viewrjo old function -->
                           <a href="<?=base_url()?>Refine_gold/refine_order_list" style="text-decoration: none;">
                                <button type="button" class="btn btn-primary" style="padding-top: 2px; padding-bottom: 2px; border: 0px;">
                                    <i class="icono-eye"></i> Refined Gold list 
                                </button></a>
                           <a href="<?=base_url()?>Refine_gold/add_refined_received_note" style="text-decoration: none;">
                                <button type="button" class="btn btn-primary" style="padding-top: 2px; padding-bottom: 2px; border: 0px;">
                                    <i class="icono-plus"></i> Add Refined Receive Note 
                                </button></a>
...
<div class="col-md-2">
 ...
 <option value="<?php echo "all"; ?>" > <?php echo "All Store"; ?></option>
...
<th style="border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" class="text-center" width="8%">RO No</th>
<th style="border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" class="text-center" width="8%">RRN No</th>
...
<th style="border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" class="text-center" width="10%">Old Gold Weight (g)</th>
<th style="border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" class="text-center" width="12%">Estimated Gold Weight - 24 kt (g)</th>
<th style="border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" class="text-center" width="12%">Refined Gold Weight - 24 kt (g)</th>
<th style="border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" class="text-center" width="12%">Difference in Weight - 24 kt (g)</th>

<th style="border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" class="text-center" width="10%">Store</th>
<th style="border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" class="text-center" width="15%">Outlet</th>
