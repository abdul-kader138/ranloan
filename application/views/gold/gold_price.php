							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<input type="text" name="goldpurity" id="goldpurity12" value="" class="form-control" placeholder="0"    maxlength="499" autofocus required autocomplete="off" />
										</div>
								</div>
								<div class="col-md-2">
									<div class="form-group">
										<label>Day Rate Per gram<span style="color: #F00">*</span></label>
										<input type="text" onkeyup="valuechange()" id="perdaterate"  name="perdaterate" class="form-control" value="" placeholder="0"   maxlength="499" autofocus required autocomplete="off" />
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
...
<!--								<div class="col-md-2">
								...
								<div class="col-md-2">
									<div class="form-group">
										<label>Day Rate Per gram<span style="color: #F00">*</span></label>
										<input type="text" onkeyup="valuechange()" id="perdaterate"  name="perdaterate" id="perdaterate" class="form-control" value="<?php echo  !empty($grade[0]->grade_price) ?$grade[0]->grade_price:''; ?>"  maxlength="499" autofocus required autocomplete="off" />
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
		...
		//alert(sel.value);
			var grade_id = $(sel).val();
				...
				success:function(data){
					...
					$('#goldpurity12').val(data.gold_purity);
					$('#perdaterate').val(data.grade_price);
				}
		 });
