			...
			{ 
			 ...
			 ?>
				<tr>
	                ...
	                <td style="text-align:center; width:50px;" valign="top"><?=($item->price)?></td>
					...
					<td style="text-align:right; width:70px;" valign="top"><?=!empty($subtotal)?($subtotal):''?></td>
				</tr>	
		<?php
				$item_id=$item->id;
    ...
    <table class="totals" cellspacing="0" border="0" style="margin-bottom:5px; border-top: 1px solid #000; border-collapse: collapse;">
		...
		<?php	}
			?>
				...
				{
					$duepay = !empty($paid_am)?$paid_am:0 - $unpaid_am;
				}else{
				...
				<tr>
					...
					<td style="text-align:right;font-weight:bold;"><?php echo !empty($duepay)?$duepay:0.00; ?></td>
				</tr>
				<tr>
					<td colspan="100%" style="border-top: 1px solid;"></td>
				</tr>
				<tr>
					...
					<td style="text-align:right;font-weight:bold;"><?php echo !empty($paid_am)?$paid_am:0 + $unpaid_am; ?></td>
				</tr>
