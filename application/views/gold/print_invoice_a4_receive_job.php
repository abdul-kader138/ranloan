...
-->
    ...
    <div id="bkpos_wrp">
    	<a href="<?=base_url()?>gold" style="width:100%; display:block; font-size:12px; text-decoration: none; text-align:center; color:#FFF; background-color:#005b8a; border:0px solid #007FFF; padding: 10px 1px; margin: 5px auto 10px auto; font-weight:bold;">Back to POS</a>
    </div>
    
    <div id="bkpos_wrp">
	    <a href="<?=base_url()?>Productions/print_invoice_receive_job?id=<?php echo $order_id; ?>" style="text-decoration: none;">
