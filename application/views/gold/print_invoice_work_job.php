...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Sale No : <?=!empty($detail_id)?$detail_id:''?></title>
...
<!--	<div style="clear:both;"></div>
    ...
    <div id="bkpos_wrp">
    	<span class="left">
    		<a href="<?=base_url()?>Productions/print_invoice_work_joba4?id=<?php echo !empty($detail_id)?$detail_id:'0'; ?>" style="width:100%; display:block; font-size:12px; text-decoration: none; text-align:center; color:#000; background-color:#4FA950; border:2px solid #4FA950; padding: 10px 0px; font-weight:bold; margin-top: 6px;">
	    		Print A4
	    	</a>
	    </span>
    </div>
