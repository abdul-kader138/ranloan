...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<form id="add_new_user_valid" action="<?=base_url()?>setting/insertUser" method="post">
	<div class="row">
		<div class="col-md-12">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="fullname" class="form-control"  maxlength="499"   autocomplete="off" value="<?php if (!empty($alert_msg)) {
                        echo $alert_msg[3];
                    } ?>" />
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="password" name="password" id="passworddata" class="form-control" maxlength="499"  autocomplete="off" value="<?php if (!empty($alert_msg)) {
                        echo $alert_msg[5];
                    } ?>" />
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="password" name="conpassword" class="form-control" maxlength="499"  autocomplete="off" value="<?php if (!empty($alert_msg)) {
                        echo $alert_msg[6];
                    } ?>" />
							</div>
						</div>
...
$("#add_new_user_valid").validate({
	  rules: {
		...
		messages: {
			...
			conpassword: "Please provide a password",
