...
class Products_model extends CI_Model
{
    ...
    {
        $this->db->select('products.id,products.code,products.name,products.category,products.grade_id,products.purchase_price,products.rack,products.thumbnail,products.alt_qty,products.product_type,products.NetGoldWeight,products.Wastagegold,products.TransferredCost,products.weight,products.sub_category_id_fk,products.status,products.product_add_from,category.name as categoryname,gold_grade.grade_name,gold_grade.gold_purity,brand.brand as brandname,(SELECT sum(gold_weight) FROM inventory WHERE product_code = products.code) as gold_weight');
        $this->db->from('products');
