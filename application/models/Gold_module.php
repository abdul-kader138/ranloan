...
class Gold_module extends CI_Model
{
	...
	{
		$this->db->select('inventory.id,inventory.gold_weight,products.product_type,products.product_add_from,products.name as productname,products.weight as product_weight,products.start_qty as product_qty,inventory.qty as inventoryqty,stores.s_name as storename, outlets.name as outletname,inventory.product_code,products.code');
