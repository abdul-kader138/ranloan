...
?>
											...
											//	}
												...
												<td><?php
														$brand_name = '';
														$brandData = $this->Constant_model->getDataOneColumn('brand', 'id', $data->brand_id_fk);
														if (count($brandData) > 0) {
															$brand_name = $brandData[0]->brand;
														}
														echo $brand_name;
													?>
												</td>
												...
												<td>
												<?php if($data->categoryname == 'Gold') { ?>
													<?=!empty($data->TransferredCost)? number_format($data->TransferredCost,2):0?>
                                                 <?php } else { ?>
                                                    <?=!empty($data->purchase_price)? number_format($data->purchase_price,2):0?>
                                                 <?php }  ?>
                                                </td>
												<td>
                                                <?php if($data->categoryname == 'Gold') { ?>
													<?=!empty( $salesPrice)? number_format( $salesPrice,2):0?>
                                                 <?php } else { ?>
                                                    <?=!empty($data->retail_price)? number_format($data->retail_price,2):0?>
                                                 <?php }  ?>
                                               
                                                <?php //!empty($data->retail_price)? number_format($data->retail_price,2):0?>
                                                </td>
