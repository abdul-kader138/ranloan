...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Customer Invoice Number : <?php echo $order_id; ?></title>
	...
	<body>	
		...
		<div class="row">
			<div class="col-md-12" >
				<div class="left" style="text-align: center; font-weight: bold;">Outlet Name : <?= !empty($getmainOrder->outlet_name) ? $getmainOrder->outlet_name : '' ?></div>
			</div>
			<div class="col-md-12">
				<div class="left" style="text-align: center; font-weight: bold;">Outlet Address : <?= !empty($getmainOrder->address) ? $getmainOrder->address : '' ?></div>
			</div>
			<div class="col-md-12">
				<div class="left" style="text-align: center; font-weight: bold;">Outlet Contact Details : <?= !empty($getmainOrder->contact_number) ? $getmainOrder->contact_number : '' ?></div>
			</div>
			<div class="col-md-12">
				<br>
			</div>
			<div class="col-md-12">
					<div class="left" style="text-align: center; font-weight: bold;">Customer Invoice : <?= !empty($getmainOrder->gold_id) ? $getmainOrder->gold_id : '' ?></div>
					<div class="left" style="text-align: right; font-weight: bold;">Print Date : <?= date('Y-m-d') ?></div>
			</div>
			<div class="col-md-12">
				<div class="left" style="text-align: right; font-weight: bold;padding-right: 20%;font-size: 18px;">Invoice No : </div>
			</div>
		</div>
				...
				<div class="panel panel-default">
					<table class="table">
						<tbody>
							<tr>
								<td>
									<div class="left" style="text-align: left; font-weight: bold;">Customer Name     : <?= !empty($getmainOrder->customer_name) ? $getmainOrder->customer_name : '' ?></div>
									<div class="left" style="text-align: left; font-weight: bold;">Customer Contact  : <?= !empty($getmainOrder->customer_mob) ? $getmainOrder->customer_mob : '' ?></div>
									<div class="left" style="text-align: left; font-weight: bold;">Customer Address  : <?= !empty($getmainOrder->customer_addre) ? $getmainOrder->customer_addre : '' ?></div>
									...
									<!--<div class="left" style="text-align: left; font-weight: bold;">Customer Order No : <?= !empty($getmainOrder->gold_id) ? $getmainOrder->gold_id : '' ?></div>-->
									<!--<div class="left" style="text-align: left; font-weight: bold;">Date : <?= $getmainOrder->gold_ordered_datetime; ?></div>-->
								</td>
							</tr> 
						</tbody>
					</table>
					<div class="col-md-12">
						<div class="left" style="text-align: right; font-weight: bold;padding-right: 15%;">Date Period :</div>
					</div>
							...
							<div class="col-md-12">
								<div class="table-responsive">
									<table class="table" border="1">
										...
										<tbody>
											<?php foreach ($getItemOrder as $item) { ?>
											<tr>
							...
							<div class="col-md-12">
								<div class="table-responsive">
									<table class="table">
										...
										<?php
											$query = $this->db->query("SELECT * FROM gold_order_services join sub_category on gold_order_services.services_name=sub_category.id WHERE order_items_gold_id = '".$item_id."' ");
											$subval=$query->result();
...
<!--											<tr>
											...
											<?php $paid_ams=$getmainOrder->gold_paid_amt; ?>
											<tr>
												<td colspan="3" style="text-align: right;"><b></b></td>
												<td colspan="2"style="text-align: right;"><b>Total Paid Amount</b></td>
												<td style="text-align: left;"><b><?=!empty($paid_ams)?number_format($paid_ams, 2):0.00 ?></b></td>
											</tr>
											<?php
											$unpaid_ams=$getmainOrder->gold_unpaid_amt;
											...
											<tr>
												...
												<td style="text-align: left;"><b><?=!empty($unpaid_ams)?number_format($unpaid_ams, 2):0.00 ?></b></td>
											</tr>
											
											<?php
											
											$grand_total = $getmainOrder->gold_grandtotal;
											if($grand_total>=$paid_ams)
											{
												$duepay = $grand_total - $paid_ams;
											}
											else
											{
												$duepay =   $paid_ams -$grand_total;
											}
											?>
											<tr>
												<td colspan="3" style="text-align: right;"><b></b></td>
											...
											<tr>
												...
												<td style="text-align: left;"><b><?=!empty($getmainOrder->gold_grandtotal)?number_format($getmainOrder->gold_grandtotal, 2):0.00 ?></b></td>
											</tr>
