													...
													<div class="col-md-12" style="padding: 0px; margin-top: 10px;">
														...
														<div class="col-md-2">
															<div class="form-group">
																...
																<input type="text"  name="minPrice" id="minPrice" placeholder="0.0"  class="form-control" />
															</div>
														</div>
														<!-- new adding end here -->
...
function calamount()
{
	...
	//$('#stock_grand_total').val(stockgrandtotl.toFixed(2)); //by a3frt
	...
	var gold_grade_name		= $("#grade_name").val();
		...
		if(min_product_price == "")
		{
			...
			else
			{
				...
				<td><input type="text"readonly name="return[' + row_item + '][total_val]" value="' + accounting.formatMoney(netamount) + '" class="form-control" style="width: 130px;">\n\
				<td width="12%">\n\
