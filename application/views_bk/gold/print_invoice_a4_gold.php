...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Customer Order No : <?php echo $order_id; ?></title>
    ...
    <table border="0" style="border-collapse: collapse; width: 100%; height: auto;">
		...
		<tr>
			<td width="100%">
				...
				<span class="left" style="text-align: left;">Customer Order No :<?=!empty($getmainOrder->gold_id)?$getmainOrder->gold_id:''?></span>
				<span class="left" style="text-align: left;">Date : <?=$getmainOrder->gold_ordered_datetime?></span>
			...
			{ 
			 ...
			 ?>
				<tr>
	                ...
	                <td style="text-align:left; width:130px; padding-bottom: 10px" valign="top"><?=$item->product_name?> <?=!empty($item->product_code)?'['.$item->product_code.']':''?></td>
...
-->
    ...
    <div id="bkpos_wrp">
	    <a href="<?=base_url()?>gold/view_invoice?id=<?php echo $order_id; ?>" style="text-decoration: none;">
