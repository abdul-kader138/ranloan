	...
	<table class="table">
		<thead>
			<tr>
		    	...
		    	<th width="15%" style="background-color: #686868; color: #FFF;">Each Cost (<?php echo $currency; ?>)</th>
			</tr>
		</thead>
		<?php
			$jj = 1;
        ...
        ?>
        		<tr>
	        		...
	        		<td colspan="2" align="right" valign="middle" style="vertical-align : middle; border-top: 1px solid #000;"><b>Total (<?php echo $currency; ?>) : </b></td>
        		...
        		<input type="hidden" id="dbtax" value="<?php echo $tax; ?>" />
				<tr>
					...
					<?php
						...
						<button class="btn btn-primary" style="font-size: 15px; padding: 15px 40px;">Receive</button>
					<?php
