...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Change Password for : <?php echo $fullname; ?></h1>
		</div>
	</div><!--/.row-->
	...
	<div class="row">
		<div class="col-md-12">
			...
			<form id="change_password_valid" action="<?=base_url()?>setting/updatePassword" method="post">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="password" name="pass" id="pass" class="form-control"  maxlength="499"   autocomplete="off" />
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label>Confirm Password <span style="color: #F00">*</span></label>
								<input type="password" name="conpass" class="form-control" maxlength="254"  autocomplete="off" />
							</div>
						</div>
					</div>
...
$("#change_password_valid").validate({
		...
		messages: {
			...
			conpass: "Please provide a password",
		},
