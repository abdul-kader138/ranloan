					...
					<?php
                        if ($order_type == '1') {
							...
							<a href="<?=base_url()?>returnorder/create_return?cust_id=<?php echo $cust_id; ?>&sales_id=<?php echo $sales_id; ?>" style="text-decoration: none;">
								<button class="btn btn-primary" style="padding: 4px 12px;">Create Return</button>
							</a>
					<?php
...
<?php
			...
			<tr>
				<td colspan="6" align="center" style="border-top: 1px solid #010101;"><b>Total</b></td>
