                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="nic" class="form-control" maxlength="499"  required autocomplete="off" value="" />
							</div>
						</div> 
					</div>
					<div class="row">
                    ...
                    <div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="number" name="outstanding" class="form-control" step=".01" autocomplete="off" value="" />
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
