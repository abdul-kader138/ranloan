...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Order No : <?=$result->id?></title>
	...
	<table border="0" style="border-collapse: collapse; width: 100%; height: auto;">
		...
		<tr>
			<td width="100%">
				...
				?>
				<span class="left" style="text-align: left;">Sale ID : <?=!empty($result->id)?$result->id:''?></span>	
				<span class="left" style="text-align: left;">Date : <?=!empty($result->ordered_datetime)?$result->ordered_datetime:''?></span>
				<span class="left" style="text-align: left;">Customer : <?=!empty($result->customer_name)?$result->customer_name:''?></span>
				<span class="left" style="text-align: left;">Grand Total : <?=!empty($grandTotal)?number_format($grandTotal,2):'0.00'?></span>
				<span class="left" style="text-align: left;">Unpaid Amount : <?=!empty($unpaid_amt)?number_format($unpaid_amt,2):'0.00'?></span>
			</td>
		</tr>   
    </table>
