<?php
    ...
    $date = $expDtaData[0]->date;
	 $transation_date = $expDtaData[0]->transation_date;
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Edit Expenses : <?php echo $number; ?></h1>
		</div>
	</div><!--/.row-->
			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<label>Expenses Ref. Number <span style="color: #F00">*</span></label>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								<label>Amount (<?php echo $site_currency ?>) <span style="color: #F00">*</span></label>
						...
						<div class="col-md-4">
							<div class="form-group">
								<label>Expense Category <span style="color: #F00">*</span></label>
								...
								?>
										<option value="<?php echo $exp_id; ?>" <?php if($exp_id == $exp_category){ echo 'selected="selected"'; } ?>>
											<?php echo $exp_name; ?>
										</option>
								<?php
										unset($exp_id);
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<label>Transation Date <span style="color: #F00">*</span></label>
								<input type="text" name="transation_date" class="form-control" id="transation_date" value="<?php echo date($site_dateformat, strtotime($transation_date)); ?>" />
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label style="letter-spacing: 0.5px;">File (Less than 2MB) <span style="color: #F00">*</span></label>
								<br />
								...
								<label style="margin-top: 10px;">
									<a href="<?=base_url()?>assets/upload/expenses/<?php echo $file_name; ?>" download>[Download File]</a>
								</label>
								<?php
