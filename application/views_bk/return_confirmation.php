...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Return Order Confirmation</h1>
		</div>
	</div><!--/.row-->
			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								<label style="font-size: 14px;">Outlet</label>
								<br />
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<label style="font-size: 14px;">Refund Amount</label>
							</div>
						</div>
						<div class="col-md-4">
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<label style="font-size: 14px;">Refund Tax</label>
							</div>
						</div>
						<div class="col-md-4">
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<label style="font-size: 14px;">Refund Grand Total</label>
							</div>
						</div>
						<div class="col-md-4">
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<label style="font-size: 14px;">Refund By</label>
							</div>
						</div>
						<div class="col-md-4">
							: <?php echo $pay_name; ?>
...
<div class="table-responsive">
	<table class="table">
		<thead>
			<tr>
		    	<th width="25%" style="background-color: #686868; color: #FFF;">Product Code</th>
		    	<th width="25%" style="background-color: #686868; color: #FFF;">Product Name</th>
		    	<th width="25%" style="background-color: #686868; color: #FFF;">Return Qty.</th>
		    	<th width="25%" style="background-color: #686868; color: #FFF;">Condition</th>
			</tr>
		</thead>
		<tbody>
		<?php
