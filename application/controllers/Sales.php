...
class Sales extends CI_Controller
{
	...
	public function sales_invoice() {
		...
		$data['select_last_sales_wherehouse']	= $this->Sales_model->select_last_sales_wherehouse($us_id);
...
/// previous Page is orders/sale.php
	...
	function getOutletWiseWarehouseProductNew()
	{
		...
		$outlet_id	= $this->input->post('outlet_id'); 
		$product_name_code_id	= $this->input->post('product_name_code_id'); 
		$productdata = $this->Sales_model->getOutletWiseWarehouseProductNew($outlet_id,$wareid,$type);
		$product = "";
		$product .= "<option value='' >Select Product Item & Code</option>";
		foreach ($productdata as $pro)
		{
...
//				
    ...
    public function reserved_Item_list()
    {
		...
		$data['getSalesResult'] = $this->Sales_model->getSalesReserved_Item_List();
    ...
    public function old_reserved_item_list()
    {
		...
		$data['getSubCategory'] = $this->Constant_model->getSubCategory();
		$data['getResult'] = $this->Sales_model->old_getReserved_Item_List();
