...
class Reports extends CI_Controller
{
	...
	public function product_report()
    {
		...
		$data['results1']		= $this->Reports_model->getProductReportDataReport();
    ...
    public function product_report_weight()
    {
		$permisssion_url = 'product_report_weight';
		$permission = $this->Constant_model->getPermissionPageWise($permisssion_url);
        ...
        $data['dateformat']		 = $format_array['dateformat'];
        $data['getStore']		 = $this->Constant_model->getStore();
		$this->load->view('reports/product_report_wt', $data);
    }
